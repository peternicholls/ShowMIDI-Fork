...
- **FR-005**: The test approach MUST include strategies to simulate or mock external dependencies (e.g., hardware MIDI devices, plugin hosts, file dialogs) to ensure deterministic tests.
- **FR-006**: The suite MUST include guidance for handling platform-conditional paths to avoid false failures and ensure parity across OSes.
...
- **FR-008**: The system MUST detect and manage flaky tests (e.g., quarantine, retry policy, reporting) to maintain trust in results.
